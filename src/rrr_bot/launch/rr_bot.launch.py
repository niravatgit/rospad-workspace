...
Launches:
  • robot_state_publisher  (publishes /robot_description → loads RRRBot in 3D sim)
...
def generate_launch_description():
    pkg = get_package_share_directory('rrr_bot')
    urdf_path = os.path.join(pkg, 'urdf', 'rr_bot.urdf')
